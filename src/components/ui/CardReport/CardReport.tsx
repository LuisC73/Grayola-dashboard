...
export function CardReport({ title, count, errorMsg }: CardReportProps) {
  return (
    <div className="flex flex-col gap-5 justify-between border border-gray-300 p-5 rounded-md bg-tertiary bg-decorate bg-no-repeat bg-right-bottom bg-[length:35%_auto]">
